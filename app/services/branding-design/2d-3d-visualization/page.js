...
const SoundEffectsIcon = () => (
  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15.536a5 5 0 001.414-1.414m-1.414-2.829a5 5 0 010-7.072m-2.828 9.9a9 9 0 010-12.728" />
  </svg>
)
...
export default function Visualization() {
  const processes = [
    { name: 'Research', icon: <ResearchIcon />, description: 'In-depth analysis and understanding of project requirements' },
    { name: 'Concept & Script', icon: <ConceptIcon />, description: 'Developing core ideas and narrative structure' },
    { name: 'Story Board', icon: <StoryboardIcon />, description: 'Visual planning of scenes and sequences' },
    { name: 'Styling', icon: <StylingIcon />, description: 'Defining visual aesthetics and design language' },
    { name: 'Voice-over', icon: <VoiceOverIcon />, description: 'Professional narration and audio recording' },
    { name: 'Animation', icon: <AnimationIcon />, description: 'Bringing visuals to life with motion and dynamics' },
    { name: 'Sound Effects', icon: <SoundEffectsIcon />, description: 'Adding audio elements for immersion' },
    { name: 'Delivers', icon: <DeliveryIcon />, description: 'Final output delivery in required formats' }
  ];
  ...
  const applications = [
    {
      ...
      items: ['Building Exteriors', 'Interior Designs', 'Landscape Planning', 'Urban Development']
    },
    {
      category: 'Product Design',
      items: ['3D Product Models', 'Packaging Designs', 'Prototype Visualization', 'Technical Drawings']
    },
    {
      category: 'Marketing & Advertising',
      items: ['Campaign Visuals', 'Concept Art', 'Promotional Materials', 'Brand Storytelling']
    }
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Transforming abstract ideas into stunning visual experiences. We bridge the gap between imagination 
                  and reality with cutting-edge 2D and 3D visualization techniques.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                A comprehensive workflow that ensures every project achieves the highest quality and impact
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {applications.map((app, index) => (
                <div key={index} className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">{app.category}</h3>
        ...
        <section className="py-20 bg-gradient-to-r from-[#20427f] to-[#2a55a8]">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Let's transform your concepts into stunning visual representations that captivate and communicate effectively.
            </p>
