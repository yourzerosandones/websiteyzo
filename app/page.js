  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="relative z-10 py-20">
            <div className="max-w-7xl mx-auto px-6 text-center">
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                We Help Complete Your
                <span className="bg-gradient-to-r from-[#20427f] to-cyan-600 bg-clip-text text-transparent"> Zeros and Ones</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/services"
                  className="bg-[#20427f] text-white px-8 py-4 rounded-xl hover:bg-[#1a3668] transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-xl"
                >
                  Explore Our Services
                </Link>
                <Link
                  href="/contact"
                  className="border-2 border-[#20427f] text-[#20427f] px-8 py-4 rounded-xl hover:bg-[#20427f]/10 transition-all duration-300 font-semibold text-lg"
                >
                  Get Started Today
                </Link>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {stats.map((stat, index) => (
                <div key={index} className="p-6">
                  <div className="text-3xl md:text-4xl font-bold text-[#20427f] mb-2">{stat.number}</div>
              ...
              {serviceCategories.map((category, index) => (
                ...
                >
                  <div className="p-8 flex-grow">
                    <div className="text-[#20427f] mb-6 flex justify-center">
                      {category.icon}
                    </div>
                    <h3 className="text-2xl font-bold text-gray-900 text-center mb-4">{category.title}</h3>
                  ...
                  <div className="p-8 pt-0 mt-auto">
                    <Link
                      href={category.link}
                      className="w-full bg-gray-900 text-white text-center py-3 px-6 rounded-lg hover:bg-gray-800 transition-colors duration-200 font-medium inline-flex items-center justify-center"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                ...
                <div key={index} className="text-center p-6">
                  <div className="w-16 h-16 bg-[#20427f] text-white rounded-full flex items-center justify-center text-lg font-bold mx-auto mb-4">
                    {process.step}
                  </div>
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-[#20427f] to-cyan-600 relative z-10">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="bg-white text-[#20427f] px-8 py-4 rounded-xl hover:bg-gray-100 transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-xl"
              >
                Get Free Consultation
              </Link>
              <Link
                href="/portfolio"
                className="border-2 border-white text-white px-8 py-4 rounded-xl hover:bg-white hover:text-[#20427f] transition-all duration-300 font-semibold text-lg"
              >
                View Our Work
              </Link>
            </div>
